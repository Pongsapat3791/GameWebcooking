...
def handle_disconnect():
    ...
    # ใช้ list(rooms.items()) เพื่อป้องกันข้อผิดพลาดขณะวนลูปและแก้ไข dictionary
...
if __name__ == '__main__':
    ...
    # เขียนไฟล์ HTML ลงในโฟลเดอร์ templates
    # (โค้ด HTML ทั้งหมดอยู่ที่นี่เพื่อความง่ายในการแจกจ่ายไฟล์เดียว)
    html_content = """
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <style>
        ...
        /* --- START: แก้ไขการแสดงผล Emoji --- */
        .item {
            font-size: 2rem; /* เพิ่มขนาดฟอนต์สำหรับ emoji */
            line-height: 1;  /* ปรับความสูงของบรรทัด */
            width: 50px;     /* กำหนดความกว้างคงที่ */
        ...
        .item-in-plate { 
            ...
            color: #166534;
            font-size: 1.25rem; /* emoji ขนาดใหญ่ขึ้นบนจาน */
            line-height: 1;
            padding: 4px;
            border-radius: 8px;
        }
        /* --- END: แก้ไขการแสดงผล Emoji --- */
...
<script>
    ...
    # รันเซิร์ฟเวอร์ด้วยวิธีมาตรฐานของ Flask-SocketIO
    # ซึ่งจะเลือกใช้ eventlet server โดยอัตโนมัติ และเป็นวิธีที่แนะนำ
